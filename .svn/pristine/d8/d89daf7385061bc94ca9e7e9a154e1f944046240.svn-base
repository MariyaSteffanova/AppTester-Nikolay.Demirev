...
namespace TestApplication.Options
{
	public class OptionsViewModel : ViewModelBase
	{
		...
		private void BrowseForHistoryFolderMethod()
		{
			...
			folderSelectDialog.SelectedPath = this.HistoryFolder;
		...
		{
			FolderBrowserDialog folderSelectDialog = new FolderBrowserDialog();
			folderSelectDialog.SelectedPath = this.TestsResultsFolder;
		...
		private void BrowseForBeyondCompareFolderMethod()
		{
			...
			openFile.FileName = this.BeyondCompareFilePath;
            openFile.FileName = Path.GetFileName(this.BeyondCompareFilePath);
            openFile.InitialDirectory = Path.GetDirectoryName(this.BeyondCompareFilePath);
